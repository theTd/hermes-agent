...
nix run github:theTd/hermes-agent/napcat -- setup
nix run github:theTd/hermes-agent/napcat -- chat

# Or install persistently
nix profile install github:theTd/hermes-agent/napcat
hermes setup
hermes chat
```
...
```bash
git clone --branch napcat https://github.com/theTd/hermes-agent.git
cd hermes-agent
nix build
...
# /etc/nixos/flake.nix (or your system flake)
{
  inputs = {
    ...
    hermes-agent.url = "github:theTd/hermes-agent/napcat";
  };
