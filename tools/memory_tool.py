...
# Backward-compatibility shim for older tests and monkeypatch sites.
# New code should use get_memory_dir().
MEMORY_DIR = None
...
class MemoryStore:
    ...
    def add(self, target: str, content: str) -> Dict[str, Any]:
        ...
        atomicity_error = validate_atomic_memory_entry(content)
        if atomicity_error:
            return {"success": False, "error": atomicity_error}
    ...
    def replace(self, target: str, old_text: str, new_content: str) -> Dict[str, Any]:
        ...
        if scan_error:
            return {"success": False, "error": scan_error}
        atomicity_error = validate_atomic_memory_entry(new_content)
        if atomicity_error:
            return {"success": False, "error": atomicity_error}
