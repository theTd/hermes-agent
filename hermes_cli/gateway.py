...
_PLATFORMS = [
    ...
    },
    {
        ...
        "label": "NapCat / QQ",
        "emoji": "🐧",
        "token_var": "NAPCAT_WS_URL",
        "setup_instructions": [
            "1. In NapCat OneBot 11, enable a forward WebSocket server",
            "2. Set messagePostFormat to array",
            "3. Copy the WebSocket URL, for example ws://127.0.0.1:3001/",
            "4. If you configured a OneBot token, copy it as well",
            "5. Restrict access with NAPCAT_ALLOWED_USERS or enable NAPCAT_ALLOW_ALL_USERS explicitly",
        ],
        "vars": [
            {"name": "NAPCAT_WS_URL", "prompt": "Forward WebSocket URL", "password": False,
             "help": "For example ws://127.0.0.1:3001/ from NapCat OneBot 11 websocketServers."},
            {"name": "NAPCAT_TOKEN", "prompt": "OneBot token (optional)", "password": True,
             "help": "If NapCat OneBot token auth is enabled, paste the token here."},
            {"name": "NAPCAT_ALLOWED_USERS", "prompt": "Allowed QQ user IDs (comma-separated)", "password": False,
             "is_allowlist": True,
             "help": "QQ user IDs that may talk to Hermes through NapCat."},
            {"name": "NAPCAT_HOME_CHANNEL", "prompt": "Home target (optional, group:123456 or private:10001)", "password": False,
             "help": "Used for cron and cross-platform delivery. Prefix with group: or private:."},
        ],
    },
    {
        "key": "whatsapp",
