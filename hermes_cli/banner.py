...
def _check_via_rev(local_rev: str) -> Optional[int]:
    """Compare an embedded git revision to the standalone napcat branch via ls-remote.
    ...
    try:
        result = subprocess.run(
            ["git", "ls-remote", STANDALONE_REPO_URL, f"refs/heads/{STANDALONE_UPDATE_BRANCH}"],
...
def _check_via_local_git(repo_dir: Path) -> Optional[int]:
    """Count commits behind the standalone napcat ref in a local checkout."""
