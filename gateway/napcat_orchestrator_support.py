...
class NapCatOrchestratorSupport:
    ...
    def _build_system_prompt_shared_core(cls) -> str:
        return (
            ...
            '- Only use action=reply for the simplest direct replies or pure status/check-in questions about running work. Do not convert a completed full-agent result into a shallow router-authored answer.\n'
            ...
            "- If the user asks about progress, status, what is running, whether you are stuck, or what the child just did, use action=reply and answer from child_board or full_agent_status.\n"
            ...
            "- If the user explicitly asks you to remember, save, or persist a fact, preference, or piece of information (e.g., 'remember this', '记住这个', '把这个记下来', 'keep this in mind', 'don't forget this'), do NOT use action=reply. Use action=spawn so the full agent can use the memory tool to persist it.\n"
            ...
            "- Do NOT use action=reply for identity questions, capability questions, explanations, factual questions, or requests that need fresh investigation.\n"
            "- If the answer needs current, live, or externally verified information, hand the turn off even if the user message is short.\n"
    ...
    def _build_system_prompt_dm_rules() -> str:
        return (
            ...
            "- For device facts, device status, smart-home readings, repo analysis, explanations that require real grounding, or any substantive follow-up to a recent full-agent result, MUST use action=spawn.\n"
        )
