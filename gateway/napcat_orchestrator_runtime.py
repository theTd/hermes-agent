...
class NapCatOrchestratorRuntime:
    ...
    def heuristic_orchestrator_decision(
        ...
        *,
        ...
        if source.chat_type != "dm" and not self.support.group_message_clearly_agent_related(
            user_message=msg,
            source=source,
            session=session,
            ...
            return OrchestratorDecision(
                ...
                ignore_message=True,
                reasoning_summary=(
                    "Fallback ignored a group message that was not clearly directed at the agent."
                ),
                raw_response=failure_reason,
                used_fallback=True,
            )
    ...
    async def run_orchestrator_agent(
        ...
        *,
        ...
        orchestrator_system_prompt = self.support.build_system_prompt()
        ...
        agent._build_system_prompt = (
            lambda system_message=None, _prompt=orchestrator_system_prompt: _prompt
        )
            ...
            try:
                ...
                with self._bind_trace_context(agent_trace_ctx):
                    result = agent.run_conversation(
                        ...
                        conversation_history=self.support.compact_history(history),
    ...
    async def send_orchestrator_public_reply(
        ...
        *,
        ...
        try:
            ...
            try:
                images, text_content = adapter.extract_images(stripped)
            except Exception:
    ...
    def _sanitize_child_public_reply_text(
        ...
        *,
        ...
        return str(NapCatPromotionSupport.sanitize_response(cleaned, protocol, "") or "").strip()
